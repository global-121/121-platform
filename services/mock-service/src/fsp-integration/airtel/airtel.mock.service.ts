...
export class AirtelMockService {
  ...
  public async disburseV2(
    ...
    // Pin encryption is not checked in this mock service. Because the encryption version used by airtel is not supported anymore by Node.js https://www.cvedetails.com/cve/CVE-2023-46809/.
