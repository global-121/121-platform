...
export class CommercialBankEthiopiaMockService {
  // Mocks Account Enquiry ##TODO: Refactor rename this function (name is Accenture legacy)
  public async postCBEValidation(payload): Promise<any> {
    // ##TODO: Do we need different mock scenarios in this function? If so, impelement them. If not, remove all related code.
  ...
  // Mocks Credit Transfer ##TODO: Refactor rename this function (name is Accenture legacy)
  public async postCBETransfer(
    payload: string, // ## TODO: Use value from payload in response structure
  ): Promise<any> {
    // Define the success transaction Status object
    const successTransactionStatus = {
  ...
  // Mocks Transaction/transfer Status Enquiry ##TODO: Refactor rename this function (name is Accenture legacy)
