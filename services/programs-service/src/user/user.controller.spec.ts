...
const userRo = {
  "user": {
    "username": "string",
    "email": "test@test.nl",
    "token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MiwidXNlcm5hbWUiOiJzdHJpZG5nIiwiZW1haWwiOiJ0ZXNkZnN0QHRlc3QubmwiLCJleHAiOjE1NjYwMzE4MzEuMjk0LCJpYXQiOjE1NjA4NDc4MzF9.tAKGcABFXNd2dRsvf3lZ-4KzUvKGeUkmuhrzGKdfLpo",
    "role": "aidworker",
    "countryId": 1
  }
}
...
class UserServiceMock {
  ...
  async findOne(loginUserDto: LoginUserDto): Promise<UserEntity> {
    ...
    user.password = 'c90f86e09c3461da52b3d8bc80ccd6a0d0cb893b1a41bd461e8ed31fa21c9b6e';
    user.role = 'aidworker';
    user.countryId = 1;
    return user
  }
