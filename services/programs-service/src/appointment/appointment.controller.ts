...
export class AppointmentController {
  ...
  public async postAvailability(
    ...
    return await this.appointmentService.postAvailability(userId, availabilityData);
  }
  ...
  public async getAvailability(@Param('programId') programId: number): Promise<AvailabilityEntity[]> {
  ...
  public async registerTimeslot(@Param('timeslotId') timeslotId: number): Promise<AppointmentEntity> {
  ...
  @Get('appointments')
  public async getAppointments(@User('id') userId: number): Promise<AppointmentEntity[]> {
