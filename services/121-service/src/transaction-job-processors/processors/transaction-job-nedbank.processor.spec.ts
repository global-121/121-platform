...
describe('TransactionJobProcessorNedbank', () => {
  ...
  let paymentProcessor: TransactionJobProcessorNedbank;
  ...
  it('should call processNedbankTransactionJob and remove job from Redis set', async () => {
    ...
    // Act
    await paymentProcessor.handleNedbankTransactionJob(testJob);
  ...
  it('should handle errors and still remove job from Redis set', async () => {
    ...
    // Act & Assert
    await expect(
      paymentProcessor.handleNedbankTransactionJob(testJob),
