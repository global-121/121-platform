...
import { TransferJobProcessorIntersolveVisa } from '@121-service/src/transfer-job-processors/processors/transfer-job-intersolve-visa.processor';
...
@Module({
  ...
  providers: [
    ...
    TransferJobProcessorIntersolveVisa,
