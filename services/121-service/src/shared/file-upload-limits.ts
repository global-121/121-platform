...
export const REGISTRATION_IMPORT_CSV_FILE_UPLOAD_LIMITS = createFileUploadLimits({
  fileSize:
    MAX_REGISTRATION_IMPORT_ROWS_PER_UPLOAD * BYTES_PER_ALLOWED_ROW,
  files: MAX_FILES_PER_UPLOAD,
});

export const REGISTRATION_BULK_PATCH_CSV_FILE_UPLOAD_LIMITS = createFileUploadLimits({
  fileSize:
    MAX_REGISTRATION_BULK_PATCH_ROWS_PER_UPLOAD * BYTES_PER_ALLOWED_ROW,
  files: MAX_FILES_PER_UPLOAD,
});

export const EXCEL_FILE_UPLOAD_LIMITS = createFileUploadLimits({
  fileSize:
    MAX_EXCEL_RECONCILIATION_ROWS_PER_UPLOAD * BYTES_PER_ALLOWED_ROW,
  files: MAX_FILES_PER_UPLOAD,
});

export const IMAGE_FILE_UPLOAD_LIMITS = createFileUploadLimits({
  fileSize: 5 * BYTES_PER_MEGABYTE,
  files: MAX_FILES_PER_UPLOAD,
});

export const ATTACHMENT_FILE_UPLOAD_LIMITS = createFileUploadLimits({
