...
export const REGISTRATION_IMPORT_CSV_FILE_UPLOAD_LIMITS: MulterModuleOptions['limits'] = {
  fileSize:
...
export const REGISTRATION_BULK_PATCH_CSV_FILE_UPLOAD_LIMITS: MulterModuleOptions['limits'] = {
  fileSize:
