...
export class RegistrationEntity extends Base121Entity {
  ...
  @ManyToOne((_type) => ProjectFinancialServiceProviderConfigurationEntity, {
    onDelete: 'SET NULL',
  })
  @JoinColumn({
    name: 'projectFinancialServiceProviderConfigurationId',
  })
  public projectFinancialServiceProviderConfiguration: ProjectFinancialServiceProviderConfigurationEntity;
  @Column({ type: 'integer', nullable: true })
