...
export class RegistrationsController {
  ...
  @ApiResponse({
    status: HttpStatus.OK,
    description:
      'Returns duplicate registrations for a registration. NOTE: this endpoint is scoped, it is only possible to request duplicates for a registration that the logged in user has access to. For the duplicates registrations that are returned the "name" property is only vissisble for registrations in the user scope.',
