...
export class RegistrationAttributeData extends Base121Entity {
  @ManyToOne(
    (_type) => RegistrationEntity,
    (registration) => registration.attributeData,
  )
  ...
  public async getDataName(): Promise<string | void> {
    const repo = AppDataSource.getRepository(RegistrationAttributeData);
