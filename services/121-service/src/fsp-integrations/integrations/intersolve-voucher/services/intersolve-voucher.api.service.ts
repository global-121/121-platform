...
import { IntersolveCancelTransactionByRefPosResponse } from '@121-service/src/fsp-integrations/integrations/intersolve-voucher/dto/intersolve-cancel-transaction-by-ref-pos-response.dto';
import { IntersolveGetCardResponse } from '@121-service/src/fsp-integrations/integrations/intersolve-voucher/dto/intersolve-get-card-response.dto';
