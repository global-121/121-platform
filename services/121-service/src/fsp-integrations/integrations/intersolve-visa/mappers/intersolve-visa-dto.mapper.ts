import { IntersolveVisaCardDto } from '@121-service/src/fsp-integrations/integrations/intersolve-visa/dtos/internal/intersolve-visa-card.dto';
...
export class IntersolveVisaDtoMapper {
  ...
  public static mapParentWalletEntityToWalletDto({
    ...
    maxCentsToSpendPerMonth: number;
    ...
    const dto: IntersolveVisaWalletDto = {
      ...
      maxToSpendPerMonth: maxCentsToSpendPerMonth,
