...
import { INTERSOLVE_VOUCHER_PAPER_ENV_VARIABLE_SETTINGS } from '@121-service/src/fsp-integrations/settings/intersolve-voucher-paper/intersolve-voucher-paper-env-variable-settings.const';
import { INTERSOLVE_VOUCHER_WHATSAPP_ENV_VARIABLE_SETTINGS } from '@121-service/src/fsp-integrations/settings/intersolve-voucher-whatsapp/intersolve-voucher-whatsapp-env-variable-settings.const';
