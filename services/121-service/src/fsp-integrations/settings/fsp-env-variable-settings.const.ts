...
import { AL_FOUAD_ENV_VARIABLE_SETTINGS } from '@121-service/src/fsp-integrations/settings/al-fouad/al-fouad-env-variable-settings.const';
...
export const FSP_ENV_VARIABLE_SETTINGS: FspEnvVariableSettingsRecord = {
  ...
  [Fsps.alFouad]: AL_FOUAD_ENV_VARIABLE_SETTINGS,
...
export const FSP_MODES: Readonly<Record<Fsps, FspMode>> = {
  ...
  [Fsps.alFouad]: AL_FOUAD_ENV_VARIABLE_SETTINGS.mode,
