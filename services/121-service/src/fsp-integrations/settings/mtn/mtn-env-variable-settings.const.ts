import { env, mtnEnvVariablesSchema } from '@121-service/src/env';
...
export const MTN_ENV_VARIABLE_SETTINGS: FspEnvVariablesDto = {
  mode: env.MTN_MODE,
  variables: getEnvVariablesForFsp({
    names: Object.keys(mtnEnvVariablesSchema),
    allEnvVariables: env,
  }),
};
