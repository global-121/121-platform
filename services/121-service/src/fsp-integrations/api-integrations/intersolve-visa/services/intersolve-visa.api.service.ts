...
import { CreateCustomerRequestIntersolveApiDto } from '@121-service/src/fsp-integrations/api-integrations/intersolve-visa/dtos/intersolve-api/create-customer-request-intersolve-api.dto';
import { CreateCustomerResponseIntersolveApiDto } from '@121-service/src/fsp-integrations/api-integrations/intersolve-visa/dtos/intersolve-api/create-customer-response-intersolve-api.dto';
import { CreatePhysicalCardRequestIntersolveApiDto } from '@121-service/src/fsp-integrations/api-integrations/intersolve-visa/dtos/intersolve-api/create-physical-card-request-intersolve-api.dto';
import { GetCustomerIndividualIntersolveApiDto } from '@121-service/src/fsp-integrations/api-integrations/intersolve-visa/dtos/intersolve-api/get-customer-individual-intersolve-api.dto';
import { GetPhysicalCardResponseIntersolveApiDto } from '@121-service/src/fsp-integrations/api-integrations/intersolve-visa/dtos/intersolve-api/get-physical-card-response-intersolve-api.dto';
import { GetTokenResponseIntersolveApiDto } from '@121-service/src/fsp-integrations/api-integrations/intersolve-visa/dtos/intersolve-api/get-token-response-intersolve-api.dto';
import { GetTransactionsResponseIntersolveVisaDto } from '@121-service/src/fsp-integrations/api-integrations/intersolve-visa/dtos/intersolve-api/get-transactions-response-intersolve-api.dto';
import { IssueTokenRequestIntersolveApiDto } from '@121-service/src/fsp-integrations/api-integrations/intersolve-visa/dtos/intersolve-api/issue-token-request-intersolve-api.dto';
import { IssueTokenResponseIntersolveApiDto } from '@121-service/src/fsp-integrations/api-integrations/intersolve-visa/dtos/intersolve-api/issue-token-response-intersolve-api.dto';
import { BaseResponseIntersolveApiDto } from '@121-service/src/fsp-integrations/api-integrations/intersolve-visa/dtos/intersolve-api/partials/base-response-intersolve-api.dto';
...
import { SubstituteTokenRequestIntersolveApiDto } from '@121-service/src/fsp-integrations/api-integrations/intersolve-visa/dtos/intersolve-api/substitute-token-request-intersolve-api.dto';
import { TransactionsIntersolveApiDto } from '@121-service/src/fsp-integrations/api-integrations/intersolve-visa/dtos/intersolve-api/transactions-intersolve-api.dto';
import { TransferRequestIntersolveApiDto } from '@121-service/src/fsp-integrations/api-integrations/intersolve-visa/dtos/intersolve-api/transfer-request-intersolve-api.dto';
import { TransferResponseIntersolveApiDto } from '@121-service/src/fsp-integrations/api-integrations/intersolve-visa/dtos/intersolve-api/transfer-response-intersolve-api.dto';
import { IntersolveBlockTokenReasonCodeEnum } from '@121-service/src/fsp-integrations/api-integrations/intersolve-visa/enums/intersolve-block-token-reason-code.enum';
...
import { CreateCustomerResult } from '@121-service/src/fsp-integrations/api-integrations/intersolve-visa/interfaces/create-customer-result.interface';
import { GetPhysicalCardResult } from '@121-service/src/fsp-integrations/api-integrations/intersolve-visa/interfaces/get-physical-card-result.interface';
...
import { GetTransactionInformationResult } from '@121-service/src/fsp-integrations/api-integrations/intersolve-visa/interfaces/get-transaction-information-result.interface';
import { IssueTokenResult } from '@121-service/src/fsp-integrations/api-integrations/intersolve-visa/interfaces/issue-token-result.interface';
