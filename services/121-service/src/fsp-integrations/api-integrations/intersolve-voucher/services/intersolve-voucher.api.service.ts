...
import { IntersolveCancelTransactionByRefPosResponse } from '@121-service/src/fsp-integrations/api-integrations/intersolve-voucher/dto/intersolve-cancel-transaction-by-ref-pos-response.dto';
import { IntersolveGetCardResponse } from '@121-service/src/fsp-integrations/api-integrations/intersolve-voucher/dto/intersolve-get-card-response.dto';
import { IntersolveIssueCardResponse } from '@121-service/src/fsp-integrations/api-integrations/intersolve-voucher/dto/intersolve-issue-card-response.dto';
...
import { IntersolveVoucherSoapElements } from '@121-service/src/fsp-integrations/api-integrations/intersolve-voucher/enum/intersolve-voucher-soap.enum';
import { IntersolveGetCardSoapResponse } from '@121-service/src/fsp-integrations/api-integrations/intersolve-voucher/interfaces/intersolve-get-card-soap-response.interface';
