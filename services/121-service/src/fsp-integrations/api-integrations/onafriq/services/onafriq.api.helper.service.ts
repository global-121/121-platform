...
import { OnafriqApiCallServiceRequestBody } from '@121-service/src/fsp-integrations/api-integrations/onafriq/dtos/onafriq-api/onafriq-api-call-service-request-body.dto';
import { OnafriqApiCallServiceResponseBody } from '@121-service/src/fsp-integrations/api-integrations/onafriq/dtos/onafriq-api/onafriq-api-call-service-response-body.dto';
import { OnafriqApiCallServiceResponseTransactionStatusCode } from '@121-service/src/fsp-integrations/api-integrations/onafriq/enum/onafriq-api-call-service-response-transaction-status-code.enum';
...
import { CallServiceResult } from '@121-service/src/fsp-integrations/api-integrations/onafriq/interfaces/call-service-result.interface.';
