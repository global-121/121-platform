export enum FspMode {
  ...
  // configurable using the backend API or even visible in the admin UI. See
  // AB#39825 and AB#38588. In this mode we do *not* require other environment
  // variables to be set for the FSP.
  //
