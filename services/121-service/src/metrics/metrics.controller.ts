...
export class MetricsController {
  ...
  @ApiOperation({
    summary: `[SCOPED] Retrieve data for export. Filters only work for export type ${ExportType.registrations}. If no "select" is provided, then the default export columns will be returned.`,
  })
  @ApiResponse({
