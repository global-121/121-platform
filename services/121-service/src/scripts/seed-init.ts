    ...
    const defaultRoles = [
      ...
      },
      {
        ...
        permissions: [
          ...
          PermissionEnum.ProjectAttachmentsREAD,
      ...
      },
      {
        ...
        permissions: [
          ...
          PermissionEnum.ProjectMetricsREAD,
          PermissionEnum.ProjectAttachmentsREAD,
          PermissionEnum.ProjectAttachmentsCREATE,
          PermissionEnum.PaymentREAD,
          PermissionEnum.PaymentTransactionREAD,
          PermissionEnum.PaymentVoucherREAD,
          PermissionEnum.FspDebitCardREAD,
          ...
          PermissionEnum.ActionREAD,
          PermissionEnum.AidWorkerProjectREAD,
          PermissionEnum.AidWorkerProjectUPDATE,
          PermissionEnum.RegistrationStatusPausedUPDATE,
        ],
      },
      {
        role: DefaultUserRole.CvaOfficer,
        label: 'Cash Assistance Project Officer',
        permissions: [
          PermissionEnum.ProjectMetricsREAD,
          PermissionEnum.ProjectAttachmentsREAD,
          PermissionEnum.PaymentREAD,
