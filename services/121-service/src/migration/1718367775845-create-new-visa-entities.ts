...
export class CreateNewVisaEntities1718367775845 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "121-service"."intersolve_visa_child_wallet" ("id" SERIAL NOT NULL, "created" TIMESTAMP NOT NULL DEFAULT now(), "updated" TIMESTAMP NOT NULL DEFAULT now(), "tokenCode" character varying NOT NULL, "isLinkedToParentWallet" boolean NOT NULL DEFAULT false, "isTokenBlocked" boolean NOT NULL, "isDebitCardCreated" boolean NOT NULL DEFAULT false, "walletStatus" character varying NOT NULL, "cardStatus" character varying, "lastUsedDate" TIMESTAMP, "lastExternalUpdate" TIMESTAMP NOT NULL, "intersolveVisaParentWalletId" integer, CONSTRAINT "UQ_8d14f1ebd6bb4e145692e264c81" UNIQUE ("tokenCode"), CONSTRAINT "PK_4dc8497d497c3f616b95b81bf4a" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "121-service"."intersolve_visa_parent_wallet" ("id" SERIAL NOT NULL, "created" TIMESTAMP NOT NULL DEFAULT now(), "updated" TIMESTAMP NOT NULL DEFAULT now(), "intersolveVisaCustomerId" integer NOT NULL, "tokenCode" character varying NOT NULL, "isLinkedToVisaCustomer" boolean NOT NULL DEFAULT false, "balance" integer NOT NULL DEFAULT '0', "lastExternalUpdate" TIMESTAMP NOT NULL, "spentThisMonth" integer NOT NULL DEFAULT '0', "lastUsedDate" date, CONSTRAINT "UQ_9ac897d2fd3f7956e20afbe010a" UNIQUE ("tokenCode"), CONSTRAINT "REL_2975915495fd7289eaad6f4705" UNIQUE ("intersolveVisaCustomerId"), CONSTRAINT "PK_d13a985f2c42065b197689a17e5" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "121-service"."transaction" ALTER COLUMN "financialServiceProviderId" SET NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "121-service"."transaction" ALTER COLUMN "financialServiceProviderId" DROP NOT NULL`,
    );
    await queryRunner.query(
