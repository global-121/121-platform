...
export class Kobo1765989007478 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "121-service"."kobo" ("id" SERIAL NOT NULL, "created" TIMESTAMP NOT NULL DEFAULT now(), "updated" TIMESTAMP NOT NULL DEFAULT now(), "assetId" character varying NOT NULL, "token" character varying NOT NULL, "versionId" character varying NOT NULL, "dateDeployed" date NOT NULL, "url" character varying NOT NULL, "programId" integer NOT NULL, CONSTRAINT "UQ_528a1d991c04456ef4772c758e9" UNIQUE ("assetId"), CONSTRAINT "REL_cc59513480665889c53e46e7ee" UNIQUE ("programId"), CONSTRAINT "PK_4f6b295eb0aad65fc5f7657f928" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
