...
export class MultiplierDecimal1758782235042 implements MigrationInterface {
  name = 'MultiplierDecimal1758782235042';

  public async up(queryRunner: QueryRunner): Promise<void> {
    // Drop and recreate view to avoid issues with dependent objects
    ...
    await queryRunner.query(
      `ALTER TABLE "121-service"."registration"
      ALTER COLUMN "paymentAmountMultiplier" TYPE double precision
      USING "paymentAmountMultiplier"::double precision`,
    );
