...
export class DistinctnessOfRegistrations1741263428887
  implements MigrationInterface
{
  name = 'DistinctnessOfRegistrations1741263428887';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "121-service"."distinct_registration_pair" ("id" SERIAL NOT NULL, "created" TIMESTAMP NOT NULL DEFAULT now(), "updated" TIMESTAMP NOT NULL DEFAULT now(), "smallerRegistrationId" integer NOT NULL, "largerRegistrationId" integer NOT NULL, CONSTRAINT "UQ_55af22462f669b897655418ada2" UNIQUE ("smallerRegistrationId", "largerRegistrationId"), CONSTRAINT "PK_1d3668bccea2f5861ba1a96d8d0" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_c32cec93b7e82495844d8b3f33" ON "121-service"."distinct_registration_pair" ("created") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_8638ae4b13a81ad4f84c1f4c5c" ON "121-service"."distinct_registration_pair" ("smallerRegistrationId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_60801a47dc600d6ea8afd3aab8" ON "121-service"."distinct_registration_pair" ("largerRegistrationId") `,
    );
    await queryRunner.query(
      `ALTER TABLE "121-service"."distinct_registration_pair" ADD CONSTRAINT "FK_8638ae4b13a81ad4f84c1f4c5ce" FOREIGN KEY ("smallerRegistrationId") REFERENCES "121-service"."registration"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "121-service"."distinct_registration_pair" ADD CONSTRAINT "FK_60801a47dc600d6ea8afd3aab89" FOREIGN KEY ("largerRegistrationId") REFERENCES "121-service"."registration"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP VIEW "121-service"."registration_view"`);
    await queryRunner.query(
      `ALTER TABLE "121-service"."distinct_registration_pair" DROP CONSTRAINT "FK_60801a47dc600d6ea8afd3aab89"`,
    );
    await queryRunner.query(
      `ALTER TABLE "121-service"."distinct_registration_pair" DROP CONSTRAINT "FK_8638ae4b13a81ad4f84c1f4c5ce"`,
    );
    await queryRunner.query(
      `DROP INDEX "121-service"."IDX_60801a47dc600d6ea8afd3aab8"`,
    );
    await queryRunner.query(
      `DROP INDEX "121-service"."IDX_8638ae4b13a81ad4f84c1f4c5c"`,
    );
    await queryRunner.query(
      `DROP INDEX "121-service"."IDX_c32cec93b7e82495844d8b3f33"`,
    );
    await queryRunner.query(
      `DROP TABLE "121-service"."distinct_registration_pair"`,
    );
  }
}
