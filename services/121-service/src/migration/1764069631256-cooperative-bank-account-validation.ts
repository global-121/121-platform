...
export class CooperativeBankAccountValidation1764069631256
  implements MigrationInterface
{
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "121-service"."cooperative_bank_of_oromia_account_validation" DROP CONSTRAINT "FK_dc9856fae693685b5ae8c375eb6"`,
    );
    await queryRunner.query(
      `DROP INDEX "121-service"."IDX_f320769996c439d7e298f208f5"`,
    );
    await queryRunner.query(
      `DROP TABLE "121-service"."cooperative_bank_of_oromia_account_validation"`,
    );
  }
}
