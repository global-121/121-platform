...
export class Approvers1766058193913 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "121-service"."payment_approval" ("id" SERIAL NOT NULL, "created" TIMESTAMP NOT NULL DEFAULT now(), "updated" TIMESTAMP NOT NULL DEFAULT now(), "approverId" integer NOT NULL, "paymentId" integer NOT NULL, "approved" boolean NOT NULL, CONSTRAINT "PK_be16f8bd8909467e8b9fcdbfc68" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
