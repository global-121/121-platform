...
export class IgnoreDuplicates1741100815063 implements MigrationInterface {
  name = 'IgnoreDuplicates1741100815063';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "121-service"."ignored_duplicate_registration_pair" ("id" SERIAL NOT NULL, "created" TIMESTAMP NOT NULL DEFAULT now(), "updated" TIMESTAMP NOT NULL DEFAULT now(), "smallerRegistrationId" integer NOT NULL, "largerRegistrationId" integer NOT NULL, CONSTRAINT "UQ_3e5f7c695650fa3df316711f671" UNIQUE ("smallerRegistrationId", "largerRegistrationId"), CONSTRAINT "PK_9d3f30b5c6b078174c839bbbc0f" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_d495915743a81d8142e42c1bb6" ON "121-service"."ignored_duplicate_registration_pair" ("created") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_c518e3ee0e32f73e644ec05c92" ON "121-service"."ignored_duplicate_registration_pair" ("smallerRegistrationId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_ca0df95a2ee2c7f8687552c829" ON "121-service"."ignored_duplicate_registration_pair" ("largerRegistrationId") `,
    );
    await queryRunner.query(
      `ALTER TABLE "121-service"."ignored_duplicate_registration_pair" ADD CONSTRAINT "FK_c518e3ee0e32f73e644ec05c92b" FOREIGN KEY ("smallerRegistrationId") REFERENCES "121-service"."registration"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "121-service"."ignored_duplicate_registration_pair" ADD CONSTRAINT "FK_ca0df95a2ee2c7f8687552c8295" FOREIGN KEY ("largerRegistrationId") REFERENCES "121-service"."registration"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP VIEW "121-service"."registration_view"`);
    await queryRunner.query(
      `ALTER TABLE "121-service"."ignored_duplicate_registration_pair" DROP CONSTRAINT "FK_ca0df95a2ee2c7f8687552c8295"`,
    );
    await queryRunner.query(
      `ALTER TABLE "121-service"."ignored_duplicate_registration_pair" DROP CONSTRAINT "FK_c518e3ee0e32f73e644ec05c92b"`,
    );
    await queryRunner.query(
      `DROP INDEX "121-service"."IDX_ca0df95a2ee2c7f8687552c829"`,
    );
    await queryRunner.query(
      `DROP INDEX "121-service"."IDX_c518e3ee0e32f73e644ec05c92"`,
    );
    await queryRunner.query(
      `DROP INDEX "121-service"."IDX_d495915743a81d8142e42c1bb6"`,
    );
    await queryRunner.query(
      `DROP TABLE "121-service"."ignored_duplicate_registration_pair"`,
    );
  }
}
