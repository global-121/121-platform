...
export class AddTransferValueToRegistrationView1774165699613
  implements MigrationInterface
{
  name = 'AddTransferValueToRegistrationView1774165699613';

  public async up(queryRunner: QueryRunner): Promise<void> {
    // Drop and recreate view to add transferValue column
  ...
  public async down(_queryRunner: QueryRunner): Promise<void> {
    console.log(`We move forward, not back.`);
  }
}
