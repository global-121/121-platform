...
// This declared at the top of the file because it is used in the CreateProjectDto and else it is not defined yet
// It's not defined inline because typing works more convient here
const exampleAttributes: ProjectRegistrationAttributeDto[] = [
  {
    name: 'nameFirst',
