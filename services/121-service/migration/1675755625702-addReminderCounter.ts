...
export class addReminderCounter1675755625702 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE INDEX "IDX_87475bf1f4196cbe646125e503" ON "121-service"."intersolve_barcode" ("reminderCount") `);
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP INDEX "121-service"."IDX_87475bf1f4196cbe646125e503"`);
    await queryRunner.query(
