...
export class addIntersolveVisaFsp1676992303536 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "121-service"."intersolve_visa_wallet" ("id" SERIAL NOT NULL, "created" TIMESTAMP NOT NULL DEFAULT now(), "updated" TIMESTAMP NOT NULL DEFAULT now(), "tokenCode" character varying, "tokenBlocked" boolean, "expiresAt" character varying, "status" character varying, "type" character varying, "cardUrl" character varying, "controlToken" character varying, CONSTRAINT "UQ_5859fe005b0a7fb606f6f191c50" UNIQUE ("tokenCode"), CONSTRAINT "PK_ad0d5b893e3726602f7822c6f29" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_571e8d4fb00bd19be71ec359c9" ON "121-service"."intersolve_visa_wallet" ("created") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_5859fe005b0a7fb606f6f191c5" ON "121-service"."intersolve_visa_wallet" ("tokenCode") `,
    );
    await queryRunner.query(
