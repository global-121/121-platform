...
export class CbeValidationReportPermission1697024633007
  implements MigrationInterface
{
  name = 'CbeValidationReportPermission1697024633007';
  ...
  private async migrateData(manager: EntityManager): Promise<void> {
    ...
    const newPermission = 'fsp:cbe:validation-report.read' as PermissionEnum;
    ...
    const closestPermission = 'payment.create' as PermissionEnum;
