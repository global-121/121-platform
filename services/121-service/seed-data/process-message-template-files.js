...
// node services/121-service/seed-data/process-message-template-files.js prepare-to-update-transifex --in services/121-service/seed-data/message-template/message-template-pilot-nl-2.json --out ./message-template-pilot-nl-2.json
const fs = require('fs');
