...
@Component({
  selector: 'app-payment-history-content',
  templateUrl: './payment-history-content.component.html',
  styleUrls: ['./payment-history-content.component.css'],
})
export class PaymentHistoryContentComponent implements OnInit {
  @Input()
