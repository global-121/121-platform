...
export class OrderDebitCardsDialogComponent {
  private static readonly phoneNumberPattern = /^\+[1-9]\d{5,14}$/;
    ...
    addresseePhoneNumber: new FormControl<string>(
      ...
      },
      {
        validators: [
          // eslint-disable-next-line @typescript-eslint/unbound-method -- https://github.com/typescript-eslint/typescript-eslint/issues/1929#issuecomment-618695608
          Validators.required,
          Validators.pattern(OrderDebitCardsDialogComponent.phoneNumberPattern),
        ],
        nonNullable: true,
      },
    ),
    addresseeEmailAddress: new FormControl<string>(
      {
        value: '',
        disabled: false,
      },
    ...
    mutationFn: () => {
      ...
      return this.programApiService.orderVisaCards({
        ...
        visaCardOrder: {
          ...
          addresseeEmailAddress: formValues.addresseeEmailAddress,
        },
      });
    },
    onSuccess: () => {
