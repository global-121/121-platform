...
describe('ProgramSettingsPaymentApprovalPageComponent', () => {
  ...
  describe('reorderStepsOnBlur', () => {
    it('should sort additional steps by thresholdAmount ascending', () => {
      // Arrange
      const fixture = createFixture();
      const component = fixture.componentInstance;
      ...
      component.addApprovalStep();
      component.addApprovalStep();
      component.additionalSteps.at(0).controls.thresholdAmount.setValue(500);
      component.additionalSteps.at(1).controls.thresholdAmount.setValue(200);

      // Act
      component.reorderStepsOnBlur();
    ...
    it('should place steps with null amount at the end', () => {
      // Arrange
      const fixture = createFixture();
      const component = fixture.componentInstance;
