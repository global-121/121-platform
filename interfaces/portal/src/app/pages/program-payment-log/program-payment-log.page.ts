...
import { TableCellPaymentEventOverviewComponent } from '~/pages/program-payment-log/components/table-cell-payment-event-overview.component';
...
@Component({
  selector: 'app-program-payment-log',
  imports: [
  ...
  templateUrl: './program-payment-log.page.html',
  styles: ``,
  providers: [CurrencyPipe, DatePipe, DecimalPipe, ToastService],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ProgramPaymentLogPageComponent {
