...
// XXX: add duplicate test of this with date range filter once the BE supports it
test('[35621] ExportPayments', async () => {
  ...
  await test.step('Export and validate file', async () => {
    ...
    // XXX: validate this once the BE supports not sending minPayment/maxPayment attributes
