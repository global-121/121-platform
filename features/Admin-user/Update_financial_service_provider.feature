...
Feature: Update chosen Financial Service Provider of Person Affected
  ...
  Scenario: Successfully update Financial Service Provider of Person Affected
    ...
    And calls the "/connection/phone/overwrite" endpoint
    ...
    And it should reflect the updated "customData" attribute to not includde anymore "attributes" associated with the previous "Financial Service Provider"
