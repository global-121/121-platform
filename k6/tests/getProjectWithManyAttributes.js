...
export default function () {
  ...
  // get project by id and validte load time is less than 200ms
  const project = projectsPage.getProjectById(2);
  checkAndFail(project, {
    'Projectme loaded succesfully status was 200': (r) => r.status == 200,
